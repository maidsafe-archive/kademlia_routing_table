...
/// Radius of the closest group to the target
pub static PARALLELISM: usize = 4;

#[derive(Clone, Debug)]
#[allow(unused)]
/// Info struct for a node
pub struct NodeInfo {
    /// Node's public_id
...
impl NodeInfo {
    #[cfg(not(test))]
    /// Constructor of a node's info struct
...
#[allow(unused)]
impl RoutingTable {
    /// Constructor of a routing_table
    ...
    /// Get radius of the closest group
    ...
    /// Loopup a node's public_id based on the incoming endpoint info
    ...
    /// Check whether a node is already existing in the routing_table
